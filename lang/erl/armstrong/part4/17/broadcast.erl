...
%% a resource on a local network without having its address, 本地网络上寻找资源
...
%%
%%   The datagram can be broadcast on only one network by sending 发送到网络广播地址
