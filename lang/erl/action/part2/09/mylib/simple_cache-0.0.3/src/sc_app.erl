...
start(_StartType, _StartArgs) ->
    ...
    resource_discovery:trade_resources(),  % 探测有哪些节点运行着缓存服务,交换资源
...
ensure_contact() ->
    DefaultNodes = ['slave1@s1', 'slave2@s2'], case get_env(simple_cache, contact_nodes, DefaultNodes) of % 查询本地的配置项目contact_nodes
        [] ->
